...
![portada de la tasca 07](img/portadat7.png)
...
- 5.Configurar aquest arxiu amb els següents registres:
  - a.SOA (amb les dades correctament configurades)
  - b.NS que sigui el vostre servidor
  - c.Un registre A anomenat server amb la IP del servidor.
  - d.Un registre A anomenat dbserver amb la IP del client.
  - e.Un registre àlies (CNAME) amb nom data al registre dbserver
...
- 7.Configurar aquest arxiu:
  - a.SOA i NS adients.
  - b.Registres PTR corresponents al server i al dbserver.
